...
private:
    ...
    {   try
        {
            std::vector<float> r_filtered(r_t[0].toType(at::kFloat).data_ptr<float>(), r_t[0].toType(at::kFloat).data_ptr<float>() + r_t[0].numel());
            std::vector<float> t_features(r_t[1].toType(at::kFloat).data_ptr<float>(), r_t[1].toType(at::kFloat).data_ptr<float>() + r_t[1].numel());
